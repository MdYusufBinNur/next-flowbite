...
const ExampleSidebar: FC = function () {
    ...
    useEffect(() => {
        const newPage = (isBrowser() && window?.location?.pathname) || "/";
                        ...
                        <Sidebar.Items>
                            <Sidebar.ItemGroup>
                                <Sidebar.Item
                                    ...
                                    as={Link}
                                    className={
                                        "/" === currentPage ? "bg-gray-100 dark:bg-gray-700 my-1" : "my-1"
                                    }
                                >
                                    Dashboard
                                </Sidebar.Item>
                                ...
                                <Sidebar.Collapse icon={HiLockClosed} label="Authentication">
                                    <Sidebar.Item href='/authentication/sign-in' as={Link}>
                                        Sign in
                                    </Sidebar.Item>
                                    <Sidebar.Item
